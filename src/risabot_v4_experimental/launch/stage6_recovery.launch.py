...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Enable diagnostic-only Stage 6 recovery proposals.',
        ),
        Node(
            package='risabot_v4_experimental', executable='recovery_shadow',
            name='v4_recovery_shadow', output='screen',
