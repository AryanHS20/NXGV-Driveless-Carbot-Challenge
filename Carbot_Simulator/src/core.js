...
const DEFAULTS={carLengthCm:27.5,carWidthCm:18.5,wheelbaseCm:21,rearOverhangCm:4.2,minimumTurningRadiusCm:40,wheelRadiusMm:33,wheelWidthMm:25,massKg:2,courseLengthCm:700,courseWidthCm:500,laneWidthCm:29.5,steeringLagMs:120,speedLagMs:180,steeringRateDeg:180,maxSpeedCms:18,parkingSpeedCms:6,uwbNoiseCm:1.2,uwbNoiseEnabled:true,encoderScaleErrorPercent:.4,imuNoiseDeg:.35,seed:2026,noiseEnabled:true,frontCameraHeightCm:18,sideCameraHeightCm:15,frontCameraPitchDeg:25,sideCameraPitchDeg:50,cameraHorizontalFovDeg:100,lidarHeightCm:22,vehicleHeightCm:24,lineToleranceCm:5,recoveryEnabled:true,recoveryReverseCm:20,expiryMs:200};
...
const PROVENANCE={measured:['carLengthCm','carWidthCm','laneWidthCm'],assumed:['wheelbaseCm','wheelRadiusMm','wheelWidthMm','minimumTurningRadiusCm','massKg','rearOverhangCm','steeringLagMs','speedLagMs','steeringRateDeg','uwbNoiseCm','encoderScaleErrorPercent','imuNoiseDeg','cameraHorizontalFovDeg','cameraVerticalFovDeg'],course:'Drawing reconstruction: 7 m main outer width; right spur extends to 7.5 m. Drawing width and height are not a uniform screenshot scaling.',height:'Lowered LiDAR mount is a design target. Actual mast remains a confirmed overheight rule violation.'};
