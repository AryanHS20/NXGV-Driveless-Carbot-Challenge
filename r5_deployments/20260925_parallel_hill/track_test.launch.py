...
def _setup(context):
    ...
    if vehicle == 'risabot5':
        ...
        actions.append(Node(
            package='risabot_automode', executable='parallel_park_trigger',
            name='parallel_park_trigger', output='screen', parameters=[{
                'armed': False,
                'recording_name': 'parking_movement_20260925_1602',
            }],
        ))
