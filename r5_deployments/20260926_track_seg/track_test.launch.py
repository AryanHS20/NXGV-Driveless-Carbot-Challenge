...
def _setup(context):
    ...
    overrides = track_test_overrides(
        ...
        flag('enable_reverse_recovery'), target_speed_mps=float(arg('target_speed_mps')),
    )
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('target_speed_mps', default_value='0', description='Forward cruise target using encoder feedback; 0 keeps legacy duty mode.'),
